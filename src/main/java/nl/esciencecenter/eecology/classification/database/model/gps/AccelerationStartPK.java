...
/**
 * The primary key class for the uva_acc_start102 database table.
 * 
 */
@Embeddable
public class AccelerationStartPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AccelerationStartPK)) {
			return false;
		}
		AccelerationStartPK castOther = (AccelerationStartPK)other;
		return 
