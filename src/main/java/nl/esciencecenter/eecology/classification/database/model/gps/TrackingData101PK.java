...
/**
 * The primary key class for the uva_tracking_data101 database table.
 * 
 */
@Embeddable
public class TrackingData101PK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrackingData101PK)) {
			return false;
		}
		TrackingData101PK castOther = (TrackingData101PK)other;
		return 
