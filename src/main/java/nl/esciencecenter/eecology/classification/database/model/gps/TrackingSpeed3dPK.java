...
@Embeddable
public class TrackingSpeed3dPK implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TrackingSpeed3dPK)) {
            return false;
        }
        TrackingSpeed3dPK castOther = (TrackingSpeed3dPK) other;
